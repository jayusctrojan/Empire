...
tags:
  ...
  - tag2"""
                ...
                track_llm_call(AgentID.SKILL_GENERATOR, "claude-sonnet-4-6", "failure")
...
Output ONLY the Markdown content (no code blocks, no explanation):"""
                ...
                track_llm_call(AgentID.COMMAND_GENERATOR, "claude-sonnet-4-6", "failure")
...
memory: true"""
                ...
                track_llm_call(AgentID.AGENT_GENERATOR, "claude-sonnet-4-6", "failure")
...
tags:
  ...
  - tag2"""
                ...
                track_llm_call(AgentID.PROMPT_GENERATOR, "claude-sonnet-4-6", "failure")
...
{{
  ...
  "settings": {{
    "executionOrder": "v1"
                ...
                track_llm_call(AgentID.WORKFLOW_GENERATOR, "claude-sonnet-4-6", "failure")
